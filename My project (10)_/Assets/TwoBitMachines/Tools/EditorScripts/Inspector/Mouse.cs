  ...
  namespace TwoBitMachines.Editors
  {
          public static class Mouse
          {
                  ...
                  public static void Update ( )
                  {
                          ...
                          middle = (guiEvent.type == EventType.MouseDown && guiEvent.button == 2);
                          ...
                          if (rightDown) rightHold = true;
                          if (middle) middleHold = true;
                          if (down) holding = true;
                          if (up) dragging = false;
                          if (anyUp) holding = middleHold = rightHold = dragging = middleDragging = false;
