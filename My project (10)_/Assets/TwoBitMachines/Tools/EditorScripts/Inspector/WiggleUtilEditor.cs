  ...
  namespace TwoBitMachines.Editors
  {
          public class WiggleUtilEditor
          {
                  ...
                  public static void TweenType (SerializedProperty child, string name, bool standAlone = false)
                  {
                          ...
                          if (act == Act.Wait)
                          {
                                  FoldOut.Box (1 + height, color, yOffset: -2, extraHeight : height == 1 ? 0 : 5);
                                  if (standAlone) child.Field ("Type", "act");
                          ...
                          {
                                  FoldOut.Box (3 + height, color, yOffset: -2, extraHeight : height == 1 ? 0 : 5);
                                  if (standAlone) child.Field ("Type", "act");
                                  Target (child, name);
                                  child.Field ("Time", "time");
                          ...
                          {
                                  FoldOut.Box (2 + height, color, yOffset: -2, extraHeight : height == 1 ? 0 : 5);
                                  if (standAlone) child.Field ("Type", "act");
