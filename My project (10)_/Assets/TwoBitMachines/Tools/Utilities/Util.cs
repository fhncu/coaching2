...
namespace TwoBitMachines
{
        public static class Util
        {
                ...
                public static Vector2 MousePositionUI (Canvas canvas)
                {
                        ...
                        if (canvas == null || canvas.renderMode == RenderMode.ScreenSpaceOverlay) return Input.mousePosition;
                ...
                public static void GetFileNames (string directoryName, string assetPath, List<string> list)
                {
                        string filePath = SearchDirectory (directoryName) + assetPath;
                ...
                public static void GetFolderStructure (string directoryName, string assetPath, string folderName, List<string> list)
                {
                        list.Clear ( );
                        string filePath = SearchDirectory (directoryName) + assetPath;
