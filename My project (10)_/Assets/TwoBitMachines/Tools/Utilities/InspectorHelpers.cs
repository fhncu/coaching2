  ...
  namespace TwoBitMachines.Editors
  {
          ...
          public static class Tint // Color "Manager"
          {
                  ...
                  public static Color LightGrey = new Color32 (202, 200, 200, 255); /* LightGrey  */
                  public static Color EventColor = new Color32 (228, 229, 228, 255); /* Event Color */
                  public static Color AlwaysState = new Color32 (123, 133, 215, 255);
                  //Color: #f85a9d
                  // public static Color SoftDark { get { return Art.Color ("soft"); } }
          }
