...
namespace TwoBitMachines.Safire2DCamera.Editors
{
            ...
            public class CameraEngineEditor : Editor
            {
                        ...
                        private void OnEnable ( )
                        {
                                    ...
                                    if (MonoImporter.GetExecutionOrder (monoScript) != 20000) MonoImporter.SetExecutionOrder (monoScript, 20000);
                        ...
                        public override void OnInspectorGUI ( )
                        {
                                    ...
                                    parent.Update ( );
                                    {
                                                ...
                                                Follow.CustomInspector (follow, barColor, labelColor);
                        ...
                        {
                                    if (main.cameraRef == null) main.cameraRef = main.GetComponent<Camera> ( );
                                    if (main.cameraRef == null) return;
                                    DrawModules (main, this);
                                    DrawFollow (main);
                        }

                        public static void DrawModules (Safire2DCamera main, Editor editor)
                        {
                                    Layout.Update ( );
                                    Layout.Update ( );
                                    {
                        ...
                        private void CreateDragAndDropArea ( )
                        {
                                    ...
                                    Rect dropArea = Layout.CreateRectAndDraw (Layout.longInfoWidth, 27, xOffset: -11, texture : Icon.Get ("RoomExit"), color : Color.white);
                                    ...
                                    if (dropArea.ContainsMouseDown (false))
                                    {
                                                ...
                                                {
                                                            if (!ModuleEnabled (modules[i])) menu.AddItem (new GUIContent (Util.ToProperCase (modules[i])), false, AddModule, modules[i]);
                                                }
                                                menu.ShowAsContext ( );
                                    }
                        }
                        ...
                        public void AddModule (object obj)
                        {
                                    ...
                                    else
                                    {
                                                ...
                                                if (property != null) property.SetTrue ("edit");
                                    }
                        ...
                        {
                                    SerializedProperty property = this.serializedObject.Get (module);
                                    if (property != null) return property.Bool ("edit");
                                    property = this.serializedObject.Get ("follow").Get (module);
                        ...
                        public static void DrawFollow (Safire2DCamera main)
                        {
                                    ...
                                    if (main.follow.view && main.follow.enable && main.targetTransform != null && main.follow.followType == FollowType.Target)
                                    {
                                                ...
                                                if (deadZone.x != 0 || deadZone.y != 0)
                                                {
                                                            ...
                                                            {
                                                                        if (main.follow.deadZone.originalSize != main.follow.deadZone.size) main.follow.deadZone.Set (main.follow.TargetPosition ( ));
                                    ...
                                    if (main.follow.view && main.follow.enable && main.follow.screenZone.size != Vector2.zero)
                                    {
                                                ...
                                                if (screenZone.x > 0) SceneTools.DottedLine (cameraPosition + V * (height - offsetY) + H * width * screenZone.x, cameraPosition - V * (height - offsetY) + H * width * screenZone.x);
                                                if (screenZone.x > 0) SceneTools.DottedLine (cameraPosition + V * (height - offsetY) - H * width * screenZone.x, cameraPosition - V * (height - offsetY) - H * width * screenZone.x);
                                                if (screenZone.y > 0) SceneTools.DottedLine (cameraPosition - V * height * screenZone.y - H * (width - offsetX), cameraPosition - V * height * screenZone.y + H * (width - offsetX));
                                                if (screenZone.y > 0) SceneTools.DottedLine (cameraPosition + V * height * screenZone.y - H * (width - offsetX), cameraPosition + V * height * screenZone.y + H * (width - offsetX));
                                    }
                                    ...
                                    if (main.follow.lookAhead.enable && main.follow.lookAhead.view && main.follow.enable)
                                    {
                                                ...
                                                {
                                                            if (distanceX > 0) SceneTools.Line (cameraPosition + V * height + H * width * distanceX, cameraPosition - V * height + H * width * distanceX);
                                                            if (distanceX > 0) SceneTools.Line (cameraPosition + V * height - H * width * distanceX, cameraPosition - V * height - H * width * distanceX);
                                                            if (distanceY > 0) SceneTools.Line (cameraPosition - V * height * distanceY - H * width, cameraPosition - V * height * distanceY + H * width);
                                                            if (distanceY > 0) SceneTools.Line (cameraPosition + V * height * distanceY - H * width, cameraPosition + V * height * distanceY + H * width);
                                                }
                                    }
                        }
                        ...
                        {
                                    DrawModules (main, null);
                                    if (main.cameraRef == null) main.cameraRef = main.GetComponent<Camera> ( );
                                    if (main.cameraRef == null || !main.follow.enable) return; // || Camera.current.name == "SceneCamera" || Camera.current.name != main.camera.name 
