...
namespace TwoBitMachines.Safire2DCamera
{
        ...
        public class Safire2DCamera : MonoBehaviour
        {
                ...
                {
                        if (moduleName == "Follow") follow.enable = enable;
                        else if (moduleName == "Peek") peek.enable = enable;
                        else if (moduleName == "LookAhead") follow.lookAhead.enable = enable;
                        else if (moduleName == "SpeedZoom") speedZoom.enable = enable;
                        else if (moduleName == "Rooms") rooms.enable = enable;
                        else if (moduleName == "FollowBlocks") follow.followBlocks.enable = enable;
                        else if (moduleName == "HighlightTarget") follow.highlightTarget.enable = enable;
                        else if (moduleName == "Cinematics") cinematics.enable = enable;
                        else if (moduleName == "Rails") follow.rails.enable = enable;
                        else if (moduleName == "Regions") follow.regions.enable = enable;
                        else if (moduleName == "WorldClamp") worldClamp.enable = enable;
                        else if (moduleName == "WorldBounds") worldBounds.enable = enable;
                        else if (moduleName == "Shake") shake.enable = enable;
                        else if (moduleName == "Parallax") parallax.enable = enable;
                        else if (moduleName == "ParallaxFinite") parallaxFinite.enable = enable;
                        else if (moduleName == "ZoomTrigger") zoomTrigger.enable = enable;
                        else if (moduleName == "SlowMotionTrigger") slowMotionTrigger.enable = enable;
                        else if (moduleName == "BasicTrigger") basicTrigger.enable = enable;
                        else if (moduleName == "UserPan") follow.userPan.enable = enable;
                        else if (moduleName == "UserZoom") follow.userZoom.enable = enable;
                        else if (moduleName == "UserRotate") follow.userRotate.enable = enable;
                }
                ...
                /// <summary>Zoom the camera with a duration of 2 seconds.</summary>
