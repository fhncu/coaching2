        ...
        public class Rails
        {
                ...
                public void RailPause (bool value)
                {
                        for (int i = 0; i < rails.Count; i++)
                        {
                                ...
                                {
                                        if (rails[i].auto) rails[i].pauseAuto = value;
                                        return;
                                }
                        }
                }
                        ...
                        if (Follow.Open (parent, "Rails", barColor, labelColor, true, canView : true))
                        {
                                ...
                                for (int i = 0; i < array.arraySize; i++)
                                {
                                        ...
                                        FoldOut.BoxSingle (1 + autoHeight, color);
                                        {
                                                ...
                                                if (autoHeight > 0) element.Field ("Speed", "autoSpeed");
                                        }
                                        ...
                                        if (type != 3)
                                        {
                                                ...
                                                FoldOut.Box (targets.arraySize, color : FoldOut.boxColor, yOffset: -2);
                                                {
                                                        for (int j = 0; j < targets.arraySize; j++)
                                                        {
                                                                ...
                                                                if (Fields.ConstructButton ("Add")) { targets.InsertArrayElement (j); break; }
                                                                if (Fields.ConstructButton ("Minus") && targets.arraySize > 2) { targets.DeleteArrayElement (j); break; }
                                                        }
                                                }
                                        ...
                                        {
                                                FoldOut.BoxSingle (1, color : FoldOut.boxColor, yOffset: -2);
                                                {
                ...
                {
                        if (!main.follow.rails.view || !main.follow.rails.enable) return;
        ...
        public class Rail
        {
                ...
                public Vector2 AutoFollow (Vector2 followTarget, Vector2 cameraPosition, Follow follow, int index, ref int activeRailIndex)
                {
                        ...
                        for (int i = followIndex; i < targets.Count;)
                        {
                                ...
                                if ((railTarget - targets[i]).magnitude < 0.01f) followIndex++;
