...
namespace TwoBitMachines.Safire2DCamera
{
        ...
        public class Peek
        {
                ...
                {
                        if (!enable || !ignoreClamps || follow.isUser || follow.highlightTarget.active || follow.usingAutoRail) return;
                ...
                {
                        if (!enable || ignoreClamps || isUser || follow.usingAutoRail) return Vector3.zero;
