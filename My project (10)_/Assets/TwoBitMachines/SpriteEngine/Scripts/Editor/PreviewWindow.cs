...
namespace TwoBitMachines.TwoBitSprite.Editors
{
        ...
        {
                public static void Display (SpriteEngineEditor editor, SerializedObject parent, SpriteEngine main)
                {
                        Rect mainPreviewWindow = Layout.CreateRect (Layout.longInfoWidth, Layout.infoWidth, xOffset: -11);
                ...
                private static Sprite RetrieveSpriteToPreview (SpriteEngineEditor editor, SpriteEngine main, ScrollWindowInfo scrollInfo)
                {
                        ...
                        {
                                if (i != main.spriteIndex) continue;
                                List<Frame> frameArray = main.sprites[i].frame;
                ...
                private static void DisplaySpriteInWindow (Rect viewRect, ScrollWindowInfo scrollInfo, SpriteWindowInfo spriteInfo)
                {
                        ...
                        ScrollView.End ( );
                        Rect colorRect = Layout.GetLastRect (width: 15, height: 13, xOffset: -11, yOffset : 0); //place color field on top left corner of window
