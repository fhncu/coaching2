        ...
        public class SpriteEngineExtraEditor : UnityEditor.Editor
        {
                ...
                public override void OnInspectorGUI ( )
                {
                        ...
                        serializedObject.Update ( );
                        {
                                ...
                                if (spriteExists)
                                {
                                        InspectSprite.Display (parent, frames, frameIndex, sprite, true);
                ...
                public bool CreateSprite ( )
                {
                        ...
                        if (parent.Bool ("open"))
                        {
                                if (FoldOut.DropDownMenu (spriteNames, parent.Get ("shiftNames"), spriteIndex)) parent.SetFalse ("open");
                                Repaint ( );
                        }
                ...
                {
                        if (tempSprites.Count == 0 || frames == null) return;
                ...
                public void Options ( )
                {
                        ...
                        if (parent.Bool ("spriteMenu") && frames.arraySize > 0)
                        {
                                ...
                                {
                                        FoldOut.Box (Texture2D.whiteTexture, array.arraySize, Tint.SoftDark, yOffset: -1);
                                        for (int i = 0; i < array.arraySize; i++)
                                        {
                                                ...
                                                if (Fields.ConstructButton ("Add")) { array.InsertArrayElement (i); break; }
                                                if (Fields.ConstructButton ("Minus")) { array.DeleteArrayElement (i); break; }
                                        }
                                }
                ...
                private void AddTransitionToAnimation (object obj)
                {
