        ...
        public class SpriteSwapEditor : Editor
        {
                ...
                public void Skins (SerializedProperty characterSkin, SerializedProperty array, SerializedProperty skin, int i)
                {
                                ...
                                .FoldOut ( ))
                        {
                                ...
                                FoldOut.Box (sprite.arraySize, FoldOut.boxColor, yOffset: -2);
                                {
                                        for (int j = 0; j < sprite.arraySize; j++)
                                        {
                                                ...
                                                Fields.ShowSprite ((Sprite) element.objectReferenceValue, 16, xOffset : 6, yOffset : 0);
                ...
                private void CreateDragAndDropArea (SerializedProperty array, string message, Color color)
                {
                        tempSprites.Clear ( );
                        tempTexture2D.Clear ( );
                        Rect dropArea = Layout.CreateRectAndDraw (Layout.longInfoWidth, 88, xOffset: -11, yOffset: -2, texture : FoldOut.background, color : Tint.Box);
                        {
