...
namespace TwoBitMachines.FlareEngine.Interactables
{
        ...
        public class FoliageTextureArray
        {
                ...
                {
                        if (textures.Count == 0 || textures[0].texture == null) return false;
                ...
                private Texture2DArray CreateTextureArray (Texture2D texture)
                {
                        ...
                        for (int i = 0; i < textures.Count; i++)
                        {
                                if (textures[i].texture == null) textures[i].texture = texture;
                ...
                {
                        if (textures.Count == 0 || foliage.Count == 0) return;
