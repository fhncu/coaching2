...
namespace TwoBitMachines.FlareEngine.Interactables
{
        ...
        public class Rope : MonoBehaviour
        {
                ...
                private void OnDrawGizmos ( )
                {
                        ...
                        {
                                SceneTools.Circle (searchPoint, ropeRadius, Color.yellow, ropeRadius * 2f);
                        }
                        for (int i = 0; i < particle.Length; i++)
                        {
                                SceneTools.Circle (new Vector2 (particle[i].x, particle[i].y), 0.05f, Color.green, 2f);
                        ...
                        {
                                SceneTools.Circle (particle[particle.Length - 1].position, tetherRadius, Color.yellow, 4f);
                        }
                }
