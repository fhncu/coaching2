...
namespace TwoBitMachines
{
        ...
        public class InventorySO : JournalInventory
        {
                ...
                [System.NonSerialized] private InventoryUI inventory = new InventoryUI ( );
                ...
                public void Initialize (PickUpItems pickUpItem)
                {
                        ...
                        {
                                if (!inventory.ContainsItem (defaultItems[i].itemName))
                                {
                ...
                {
                        if (removeItemUI == null || pickUpItem == null) return;;
