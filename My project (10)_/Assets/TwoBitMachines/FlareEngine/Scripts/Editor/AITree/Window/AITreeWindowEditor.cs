...
namespace TwoBitMachines.FlareEngine.Editors
{
        public class AITreeWindowEditor : EditorWindow
        {
                ...
                public void GetProperties ( )
                {
                        ...
                        if (nodeList == null || nodeList.Count == 0) Util.GetFolderStructure ("TwoBitMachines", "/FlareEngine/Scripts/AI/BehaviorTree/Nodes", "Nodes", nodeList);
                        Layout.Initialize ( );
                        draw.Initialize ( );
                }
                ...
                public void OnGUI ( )
                {
                        ...
                        if (template == null)
                        {
                                template = AssetDatabase.LoadAssetAtPath<BranchTemplate> ("Assets/TwoBitMachines/FlareEngine/Scripts/AI/BehaviorTree/Tree/Template.asset");
                        }
                        ...
                        if (previousColor != backgroundColor) SaveBackgroundColor ( );
                ...
                public void ResetVariables ( )
                {
                        ...
                        if (Mouse.up || Mouse.down) tree.aNodeIsBeingDragged = false;
                }
                ...
                public void TreeNotDetectedScreen ( )
                {
                        ...
                        zoom.Grid (lineMaterial, position, 10, 10);
                        zoom.End (position);
                ...
                {
                        zoom.Grid (lineMaterial, position, tree.panX, tree.panY);
                }
                ...
                {
                        if (!tree.tempChildren.Contains (node)) tree.tempChildren.Add (node);
