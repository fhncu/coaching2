...
namespace TwoBitMachines.FlareEngine.Editors
{
        ...
        public class AITreeEditor : UnityEditor.Editor
        {
                ...
                public override void OnInspectorGUI ( )
                {
                        ...
                        if (tree.root != null) tree.root.hideFlags = HideFlags.HideInInspector;
                        parent.Update ( );
                        {
                                ...
                                AIBase.BlackboardDisplay (parent, bar, tree, dataList);
                                if (bar.intValue != 0 && FoldOut.CornerButton (Tint.Delete)) BlackboardMenu.Open (tree, dataList, bar.intValue);
                        ...
                        if (createUnits) AIBase.CreateUnits (tree);
                }

                private void InspectNode (SerializedProperty bar)
                {
                        if (bar.intValue != 0) return;
                        ...
                        if (tree.nodeMessage != null && tree.showNodeMessage)
                        {
                                ...
                                FoldOut.Box (5, FoldOut.boxColor);
                                {
                                        ...
                                        Rect rect = Layout.CreateRect (width: Layout.infoWidth + 4, height: 70, xOffset: -6);
