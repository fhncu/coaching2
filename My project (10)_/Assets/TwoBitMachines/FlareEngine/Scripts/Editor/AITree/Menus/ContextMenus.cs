...
namespace TwoBitMachines.FlareEngine.Editors
{
        public class ContextMenus
        {
                ...
                public void NoteMenu (Node node, NodeMessage message)
                {
                        ...
                        GenericMenu menu = new GenericMenu ( );
                        {
                                if (!(node is Root)) menu.AddItem (new GUIContent ("Delete Note"), false, OnNoteMenu, "Note");
                        }
                        menu.ShowAsContext ( );
                }
                ...
                {
                        if (editorRef == null || nodeRef == null) return;
                ...
                {
                        if (editorRef == null || editorRef.tree == null || nodeRef == null) return;
                        ...
                        else if (type == "CreateTemplate" && templateRef != null)
                        {
                                ...
                                if (!tree.tempChildren.Contains (nodeRef)) tree.tempChildren.Add (nodeRef);
                        ...
                        else if (type == "Duplicate Node")
                        {
                                if (CreatedAndCopyNode (nodeRef.nameType, nodeRef.rectPosition + Vector2.up * 40f, nodeRef, out Node newNode))
                                {
                                        ...
                                        if (newNode.Children ( ) != null) newNode.Children ( ).Clear ( );
                                }
                        }
                ...
                {
                        if (editorRef == null || editorRef.tree == null) return;
                ...
                private bool DeleteNode (List<Node> children, List<Node> tempChildren, Node nodeDelete)
                {
                        for (int i = children.Count - 1; i >= 0; i--)
                        {
                                if (children[i] == nodeDelete)
                                {
                                        ...
                                        if (children[i] != null) Undo.DestroyObjectImmediate (children[i]);
                                        children.RemoveAt (i);
                                        return true;
                                }
                ...
                {
                        newNode = null;
                        if (editorRef == null || editorRef.tree == null) return false;
                ...
                {
                        if (!CreateNode (template.nameType, template.position, out Node newNode)) return null;
