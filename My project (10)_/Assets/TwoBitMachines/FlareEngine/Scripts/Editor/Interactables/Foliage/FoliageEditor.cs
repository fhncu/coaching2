...
namespace TwoBitMachines.FlareEngine.Editors
{
        ...
        public class FoliageEditor : Editor
        {
                ...
                {
                        if (brush != null) DestroyImmediate (brush);
                }
                ...
                public override void OnInspectorGUI ( )
                {
                        ...
                        parent.Update ( );
                        {
                                ...
                                if (FoldOut.Bar (parent, Tint.Blue).Label ("Paint", Color.white).FoldOut ("foldOutPaint"))
                                {
                                        ...
                                        if (textArray.FieldAndButton ("Add Texture2D", "textureSize", "Add")) textArray.SetTrue ("createTexture");
                ...
                public void OnSceneGUI ( )
                {
                        ...
                        if (EditorApplication.isPlaying || Mouse.MouseRightDown ( ) || main.brushes < 0 || main.brushes == FoliageBrush.None)
                        {
                                ...
                                if (brush != null) MonoBehaviour.DestroyImmediate (brush);
                                return;
                        }
