...
namespace TwoBitMachines.FlareEngine.Editors
{
        ...
        public class QuestInventorySOEditor : Editor
        {
                        ...
                        for (int i = 0; i < array.arraySize; i++)
                        {
                                        ...
                                        .FoldOut ( ))
                                {
                                        ...
                                        for (int r = 0; r < rewards.arraySize; r++)
                                        {
                                                ...
                                                FoldOut.Box (2, Tint.BoxTwo, yOffset: -2);
                                                {
                                                ...
                                                //         Rect rectR = Layout.CreateRect (width: Layout.longInfoWidth, height: 60, xOffset: -11, yOffset: -1);
