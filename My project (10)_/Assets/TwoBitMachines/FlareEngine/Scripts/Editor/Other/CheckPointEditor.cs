        ...
        public class CheckPointEditor : UnityEditor.Editor
        {
                ...
                public override void OnInspectorGUI ( )
                {
                        ...
                        parent.Update ( );
                        {
                                ...
                                {
                                        FoldOut.Box (4, FoldOut.boxColor, extraHeight : 5, yOffset: -2);
                                        ...
                                        for (int i = 0; i < array.arraySize; i++)
                                        {
                                                ...
                                                bool open = FoldOut.Bar (element, FoldOut.boxColor, 25).BR ("delete", "Delete").FoldOut ( );
                                                ListReorder.Grip (parent, array, Bar.barStart.CenterRectHeight ( ), i, Tint.WarmWhite);

                                                if (open)
                                                {
                                                        FoldOut.Box (3, FoldOut.boxColor, extraHeight : 5, yOffset: -2);
                                                        {
