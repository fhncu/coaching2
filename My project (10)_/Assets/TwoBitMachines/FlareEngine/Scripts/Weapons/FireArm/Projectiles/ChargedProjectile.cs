...
namespace TwoBitMachines.FlareEngine
{
        ...
        public class ChargedProjectile
        {
                ...
                public void Reset (bool clearPercent = true)
                {
                        ...
                        coolDownCounter = 0;
                        dischargeCounter = 0;
                        if (clearPercent) percentCharged = 0;
                }
                ...
                {
                        if (!canCharge || projectile == null) return false;
                ...
                public void DischargeOver (bool failed = true)
                {
                        ...
                        if (!failed) onDischargingFailed.Invoke ( ); // charging failed
                        if (failed) onDischargingComplete.Invoke ( );
                }
