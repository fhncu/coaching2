...
namespace TwoBitMachines.FlareEngine
{
        ...
        public class Firearm : Tool
        {
                ...
                public bool FireProjectile (ProjectileBase projectile, Recoil recoil, bool fire, ref float counter)
                {
                        ...
                        {
                                if (projectile.FireProjectile (firePoint.position, transform.rotation, equipment.setVelocity + recoil.Offset ( )))
                                {
                                        counter = 0;
                ...
                public override void LateExecute (AbilityManager player, ref Vector2 velocity)
                {
                        ...
                        defaultProjectile.LateExecute (player, ref velocity);
                }
                ...
                {
                        if (projectileInventory == null) return false;
                        return projectileInventory.SetProjectile (defaultProjectile.projectile, name);
                }
