...
namespace TwoBitMachines.FlareEngine
{
        ...
        public class Melee : MonoBehaviour
        {
                ...
                public void Execute (AnimationSignals signals, int direction, bool onGround, Vector2 position, ref Vector2 velocity)
                {
                        if (block.canBlock && block.IsBlocking ( ))
                        {
                                ...
                                if (!melee.inMelee)
                                {
                                        block.Block (signals, ref velocity);
                                        return;
                                }
                        }
                        ...
                        if (coolDownCounter >= coolDown && melee.ExecuteMelee (signals, direction, onGround, position, coolDown, ref velocity))
                        {
                                ResetAll ( );
                        }
                }
