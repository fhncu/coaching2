...
namespace TwoBitMachines.FlareEngine
{
        ...
        public class ManageScenes : MonoBehaviour
        {
                ...
                public void Update ( )
                {
                        if (state == LoadState.wait) return; //|| loading == null) return;
        ...
        public class LoadStep
        {
                ...
                [SerializeField] private DeactivateStep deactivate;
                ...
                private bool LoadScene (LoadSceneOn loadSceneOn, string sceneName)
                {
                        ...
                        if (loadSceneOn == LoadSceneOn.Automatically || (Input.anyKeyDown || Input.touchCount > 0))
                        {
                                ...
                                Time.timeScale = 1f;
                                if (loadSceneOn == LoadSceneOn.Automatically) onComplete.Invoke ( );
                                return true;
                        }
                        return false;
                }
