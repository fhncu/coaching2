...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
        ...
        public class CornerGrabAnimation //anim signals: wall, wallCornerGrab
        {
                ...
                public void Reset ( )
                {
                        if (isGrabbing && spriteEngine != null)
                        {
                ...
                {
                        if (!player.world.onCeiling && renderer != null && animation.Count != 0)
                        {
                ...
                public bool IsPlaying (Wall wall, AbilityManager player, WorldCollision world, ref Vector2 velocity)
                {
                        ...
                        if (renderer == null || animation.Count == 0 || player.world.onCeiling || AnimationComplete (player, ref velocity) || ExitOnCeiling (player.world.box))
                        {
                                Reset ( );
                                return false;
                        }
                ...
                public void SetFinalPosition (WorldCollision world, bool value)
                {
                        if (value)
                        {
                                ...
                                {
                                        Safire2DCamera.Safire2DCamera.mainCamera.ForceFollowSmooth ( );
                                }
                        }
                }
