...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
        ...
        public class CornerGrab //anim signals: wall, wallHold, wallCornerGrab
        {
                ...
                public static void OnInspector (SerializedObject controller, SerializedObject parent, string[] inputList, Color barColor, Color labelColor)
                {
                        ...
                        {
                                FoldOut.Box (4 + height, FoldOut.boxColorLight, extraHeight : 5, yOffset: -2);
                                {
                                ...
                                {
                                        Fields.EventFoldOut (grabAnim.Get ("onAnimationStart"), cornerGrab.Get ("onStartFoldOut"), "On Animation Start", adjustX : 0, color : FoldOut.boxColorLight);
                                        Fields.EventFoldOut (grabAnim.Get ("onAnimationEnd"), cornerGrab.Get ("onEndFoldOut"), "On Animation End", adjustX : 0, color : FoldOut.boxColorLight);
                                }
                        }
