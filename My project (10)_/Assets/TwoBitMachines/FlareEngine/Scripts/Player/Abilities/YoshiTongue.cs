...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
        ...
        public class YoshiTongue : Ability
        {
                ...
                public override void Reset (AbilityManager player)
                {
                        ...
                        if (tongue != null) tongue.gameObject.SetActive (false);
                                ...
                                case State.Extract:
                                        {
                                                ...
                                                if (hit)
                                                {
                                                        ...
                                                        if (yoshiTarget != null)
                                                        {
                                                                ...
                                                                if (aiTarget != null) aiTarget.ChangeState ("Captured");
                                ...
                                case State.Retract:
                                        {
                                                ...
                                                if (targetTransform != null)
                                                {
                                                        ...
                                                        if (aiTarget != null) aiTarget.enabled = false;

                                                        if (length <= closingLength)
                                                        {
                                                                if (aiTarget != null) aiTarget.enabled = true;
                                                                if (aiTarget != null) aiTarget.ChangeState ("Killed");
                                                                if (deactivateTarget) targetTransform.gameObject.SetActive (false);
                                                                if (!closedTriggered)
                                                                {
