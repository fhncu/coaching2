...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
        ...
        public class ZipInfo
        {
                ...
                public void Enter (WorldCollision world, int index)
                {
                        zipIndex = index;
                        exitMomentum = false;
                        gravityMomentum = 0;
                ...
                public void OnStartEvent (WorldCollision world)
                {
                        onStart.Invoke (ImpactPacket.impact.Set (onStartWE, world.transform, world.boxCollider, world.transform.position, null, Vector2.zero, 0));
                }

                public void OnEndEvent (WorldCollision world)
                {
                        onEnd.Invoke (ImpactPacket.impact.Set (onEndWE, world.transform, world.boxCollider, world.transform.position, null, Vector2.zero, 0));
                }
