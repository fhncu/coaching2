...
namespace TwoBitMachines.FlareEngine.ThePlayer
{
        ...
        public class Hide : Ability
        {
                ...
                private void OnHideEvent (AbilityManager player)
                {
                        ...
                        ImpactPacket impact = ImpactPacket.impact.Set (onHideWE, this.transform, player.world.boxCollider, transform.position, null, -Vector2.right * player.playerDirection, 0);
                        onHide.Invoke (impact);
                }

                private void OnUnhideEvent (AbilityManager player)
                {
                        ImpactPacket impact = ImpactPacket.impact.Set (onUnhideWE, this.transform, player.world.boxCollider, transform.position, null, -Vector2.right * player.playerDirection, 0);
