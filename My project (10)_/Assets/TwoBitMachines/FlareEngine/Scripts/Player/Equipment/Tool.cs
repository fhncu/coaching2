...
namespace TwoBitMachines.FlareEngine
{
        public class Tool : MonoBehaviour
        {
                ...
                {
                        if (!tools.Contains (this)) tools.Add (this);
                        ToolOnEnable ( );
                }

                public void OnDisable ( )
                {
                        if (tools.Contains (this)) tools.Remove (this);
                }
                ...
                public bool EquipToolToParent ( )
                {
                        ...
                        {
                                if (equipment != null) equipment.RemoveTool (this);
                                equipment = null;
                                currentParent = null;
                                return false;
                        }
                        ...
                        else
                        {
                                ...
                                if (equipment != null) transform.localPosition = localPosition;
                                if (equipment != null) equipment.RegisterTool (this);
                        }
                        return equipment != null;
                }
