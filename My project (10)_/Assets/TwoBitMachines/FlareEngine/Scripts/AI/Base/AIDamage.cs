...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class AIDamage : MonoBehaviour
        {
                ...
                {
                        if (aiBase != null && !aiBase.damage.pauseDamage && Compute.ContainsLayer (aiBase.damage.layer, other.gameObject.layer))
                        {
                                Health.IncrementHealth (transform, other.transform, -aiBase.damage.damage, Damage.Direction (transform, other.transform, aiBase.damage.direction) * aiBase.damage.force);
                        }
                }
