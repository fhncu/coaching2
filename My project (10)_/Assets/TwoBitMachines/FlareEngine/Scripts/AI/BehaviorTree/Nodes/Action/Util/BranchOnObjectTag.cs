...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class BranchOnObjectTag : Action
        {
                ...
                {
                        if (packet.attacker == null || parent == null) return;
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        FoldOut.Box (array.arraySize, color, yOffset: -2);
                        for (int i = 0; i < array.arraySize; i++)
                        {
                                Fields.ArrayPropertyFieldDouble (array, i, "Tag, State", "tag", "state");
                        }
                        Layout.VerticalSpacing (3);
                        Fields.EventFoldOut (parent.Get ("onBranch"), parent.Get ("foldOutEvent"), "On Branch", color : color, yOffset: -2);
                        return true;
                }
