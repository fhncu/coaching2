...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class OverlapCircle : Conditional
        {
                ...
                {
                        Collider2D collider2D = Physics2D.OverlapCircle (origin.GetTarget ( ), radius, layer);
                        if (collider2D != null)
                        {
                ...
                public bool CastAll (Root root)
                {
                        ...
                        int i = Physics2D.OverlapCircle (origin.GetTarget ( ), radius, Root.filter2D, Root.colliderResults);
                        return i > 0;
                }
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        {
                                Labels.InfoBoxTop (44, "Implement an OverlapCircle using Physics2D. The results can be accessed by Nearest2DResults.");
                        }
