...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class PlayerDeath : Action
        {
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        Fields.EventFoldOut (parent.Get ("onBegin"), parent.Get ("beginFoldOut"), "On Begin", color : color, yOffset: -2);
                        Fields.EventFoldOut (parent.Get ("onTransitionBegin"), parent.Get ("beginTransitionFoldOut"), "On Transition Begin", color : color, yOffset: -2);
                        return true;
                }
