        ...
        public class SetTransform : Action
        {
                ...
                public override NodeState RunNodeLogic (Root root)
                {
                        ...
                        if (type == TransformType.Position)
                        {
                                ...
                                {
                                        if (positionTransform != null) value = positionTransform.position;
                                }
                                if (positionType == TransformPositionType.Target)
                                {
                                        if (positionTarget != null) value = positionTarget.GetTarget ( );
                                }
                        }
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        if (type == 0)
                        {
                                ...
                                if (positionType == 2) AIBase.SetRef (ai.data, parent.Get ("positionTarget"), 1);
