        ...
        public class WaterFloat : Action
        {
                ...
                public override NodeState RunNodeLogic (Root root)
                {
                        ...
                        if (root.movingPlatform.box != null) // moving platform
                        {
                                ...
                                root.velocity.y -= buoyancy * 10f * Time.deltaTime; // gravity, incase moving platform goes out of water
                ...
                private void Buoyancy (ref Vector2 velocity)
                {
                        ...
                        if (Time.deltaTime != 0 && (centerBottom + velocity.y * Time.deltaTime) >= waveTopPoint.y)
                        {
                                velocity.y = (((waveTopPoint.y - 0.1f) - centerBottom) / Time.deltaTime) * 0.5f; // Clamp player y velocity if being shot out of water too fast by spring/buoyancy
                                springVelocity = 0;
                        }
                }
