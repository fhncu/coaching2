...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class WaitForPlayerInput : Action
        {
                        ...
                        switch (state)
                        {
                                ...
                                case WaitForState.WaitForButton:
                                        ...
                                        if (inputButtonSO.Pressed ( ))
                                        {
                                                ...
                                                if (returnSuccess) return NodeState.Success;
                                        }
                                        break;
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        ...
                        Fields.EventFoldOut (parent.Get ("onPlayerEnter"), parent.Get ("playerEnterFoldOut"), "On Player Enter", color : color, yOffset: -2);
                        Fields.EventFoldOut (parent.Get ("onPlayerExit"), parent.Get ("playerExitFoldOut"), "On Player Exit", color : color, yOffset: -2);
                        Fields.EventFoldOut (parent.Get ("onButtonPressed"), parent.Get ("buttonPressedFoldOut"), "On Button Pressed", color : color, yOffset: -2);
                        return true;
                }
