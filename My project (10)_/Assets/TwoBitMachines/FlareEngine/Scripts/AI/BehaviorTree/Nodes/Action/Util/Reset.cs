...
namespace TwoBitMachines.FlareEngine.AI
{
        ...
        public class Reset : Action
        {
                ...
                [SerializeField] public ResetTo resetTo;
                ...
                public override bool OnInspector (AIBase ai, SerializedObject parent, Color color, bool onEnable)
                {
                        if (parent.Bool ("showInfo"))
                        {
                                Labels.InfoBoxTop (80,
                                        ...
                                        "exists and is true, the AI will be considered dead and deactivated. If so, this will return Success." +
                                        "\n \n Returns Running, Success"
                                );
                        }

                        int resetTo = parent.Enum ("resetTo") == 0 ? 1 : 0;
                        FoldOut.Box (6 + resetTo, color, yOffset: -2);
                        parent.Field ("Reset To", "resetTo");
                        if (resetTo == 1) AIBase.SetRef (ai.data, parent.Get ("resetPoint"), 0);
                        parent.Field ("Health Reference", "healthRef");
                        parent.Field ("Health", "healthValue");
